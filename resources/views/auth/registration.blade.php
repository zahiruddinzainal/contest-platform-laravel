                    ...
                    <section class="welcome" style="margin-top: 600px;">
                        <div class="wrapper fadeInDown">
                            <div id="formContent">
                                ...
                                <form action="{{ route('register.custom') }}" method="POST" class="mt-3">
                                    @csrf
                                    <input type="text" placeholder="Full name" style="text-align: left;" name="name" required>
                                    <input type="text" placeholder="Email address" style="text-align: left;"
                                        name="email"required>
                                    <!-- <input type="text" placeholder="Phone number" style="text-align: left;"
                                        name="phone"> -->
                                    <input type="text" placeholder="Password" style="text-align: left;" name="password"required>
                                    <!-- <input type="text" placeholder="Retype password" style="text-align: left;"
                                        name="repassword"> -->
                                    <input type="submit" class="fadeIn fourth mt-4" value="Register">

                                    <a href="./login" style="margin-bottom: 30px;">Already have an account? Login
                                        here</a>
