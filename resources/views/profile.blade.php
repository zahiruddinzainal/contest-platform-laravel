    ...
    <div class="container-fluid px-0 mt-5">
        <div class="row mx-0">
            <div class="col-12 px-0">
                <div class="centered">
                    <section class="welcome" style="margin-top: 160px;">
                        <h4 class="text-dark">Full name: {{Auth::user()->name}}</h4>
                        <h4 class="text-dark">Email address {{Auth::user()->email}}</h4>
                        <div class="container">
                            <div class="row">
                                <div class="col-sm mt-3">
                                    <a href='signout' class="btn btn-lg btn-dark font-weight-bold text-light">Sign
                                        out</a>
                                </div>
                            </div>
                        </div>
