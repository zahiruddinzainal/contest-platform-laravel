                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="d-flex justify-content-between align-items-center navbar-top">
                            <ul class="navbar-left">
                                <li>Saturday 10 July 2021</li>
                                <li>30°C Kuala Lumpur</li>
                            </ul>
                            <div>
                                <a class="navbar-brand" style="font-size: 33px; font-weight: bold;"
                                    href="#">iContest.my</a>
                            </div>
                            <div class="d-flex">
                        ...
                        <div class="navbar-bottom-menu">
                            ...
                            <div class="navbar-collapse justify-content-center collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav d-lg-flex justify-content-between align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="pages/world.html">View contest by category</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="pages/author.html">View contest by date</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="pages/business.html">How to join a contest?</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="pages/business.html">Login</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6  mb-5 mb-sm-2">
                            <div class="position-relative image-hover">
                                <img src="public/images/9.png" class="img-fluid" alt="world-news" />
                            </div>
                        </div>
                        <div class="col-lg-6 mb-2 mb-lg-2">
                            <div class="row">
                                <div class="col-sm-12  mb-2 mb-lg-2">
                                    <h1>Menangi Honda Civic 2021 dengan hashtag #myCivic</h1>
                                    <p class="mb-4">
                                        Your description here Your description here Your description here Your
                                        description here Your description here Your description here Your description
                                        here Your description here Your description here Your description here Your
                                        description here Your description here Your description here
                                    </p>
                                    <p class="mb-4">
                                        Info about prizes here.Info about prizes here.Info about prizes here.Info about
                                        prizes here.Info about prizes here.Info about prizes here.Info about prizes
                                        here.Info about prizes here.
                                    </p>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <a href="./login" class="btn btn-lg btn-dark font-weight-bold">Join contest</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
